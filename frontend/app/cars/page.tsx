  ...
  const itemsPerPage = 10;
    ...
    const fetchCars = async () => {
        ...
        try {
            ...
            setCars(data.cars || []); // Fallback pentru array vid
            setTotalPages(data.totalPages || 1); // Fallback pentru pagini
        } catch (err: any) {
...
return (
  <div className="max-w-4xl mx-auto py-8">
    ...
    {/* Error */}
    {error ? (
      <div className="flex flex-col items-center justify-center py-10 bg-rose-50 border border-rose-200 text-rose-700 rounded-lg shadow-sm mx-auto max-w-xs">
      ...
      <div className="flex flex-col items-center justify-center py-10 bg-yellow-50 border border-yellow-200 text-yellow-700 rounded-lg shadow-sm mx-auto max-w-xs animate-pulse">
      ...
      <div className="flex flex-col items-center justify-center py-10 bg-zinc-50 border border-zinc-200 text-zinc-500 rounded-lg shadow-sm mx-auto max-w-xs">
        <svg xmlns="http://www.w3.org/2000/svg"
          width="24" height="24" viewBox="0 0 24 24"
          fill="none" stroke="currentColor" strokeWidth="2"
          strokeLinecap="round" strokeLinejoin="round"
